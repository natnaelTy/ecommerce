...
const Footer = () => {
    return (
     <>
      {/* <footer className="bg-gray-100 pt-16 pb-12 border-t border-gray-100 px-4">
    ...
    <div className="bg-gray-100 py-2">
        <div className="max-w-[1000px] w-full mx-auto flex items-center justify-between">
            ...
            <div>
                <img src="./images/chapaorg.png" alt="methods" title="Chapa Payment Method" className="h-10"/>
            </div>
        </div>
    </div>
    </>
