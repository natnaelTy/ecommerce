...
export default function Checkout() {
  ...
  return (
    <div className="max-w-[1000px] w-full mx-auto p-2">
      ...
      <div className="py-6 px-4 border-1 border-gray-50 rounded-md shadow-md">
                ...
                {cartList && cartList.length > 0 ? (
                  <div className="w-full flex flex-col items-end gap-2">
                    <p className="mb-2 w-full flex justify-between">
                      Cart Subtotal:{" "}
                      <span>{formatCurrency(totalPrice, "ETB", "en-ET")}</span>
                    </p>
                    <p className="mb-2 w-full flex justify-between">
              ...
              <div>
                ...
                <div className="flex flex-col gap-5">
                  <label className="flex gap-1 text-xs font-medium text-gray-600">
                    ...
                    <Link className="text-black font-semibold hover:text-orange-500" to={"/"}>
                      Terms & Conditions
                    </Link>
                  </label>
                  <button
